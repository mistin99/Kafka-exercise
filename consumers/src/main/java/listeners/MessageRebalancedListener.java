...
public class MessageRebalancedListener implements ConsumerRebalanceListener {
    private KafkaConsumer<String, String> kafkaConsumer;
    public static final String serialiaziedFilePath = "consumers/src/main/resources/offset.ser";

    public MessageRebalancedListener(KafkaConsumer<String, String> kafkaConsumer) {
        this.kafkaConsumer = kafkaConsumer;
    }

    private static final Logger logger = LoggerFactory.getLogger(MessageRebalancedListener.class);
